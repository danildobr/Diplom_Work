...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if created:
            ...
            supplier_user.set_password('default_password')  # или используйте что-то более безопасное
            supplier_user.save()
            self.stdout.write(f'Создан пользователь поставщика: {supplier_user.username}')
